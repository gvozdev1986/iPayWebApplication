...
public class CalcilatePagination {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(CalcilatePagination.class);
	public static final String COUNT_ROW_ON_PAGE = "countRowOnPage";
	public static final Integer COUNT_ROW_ON_PAGE_DEFAULT = 10;
	...
	public static final String PAGINATION_BUTTON_ARRAY_ATTIRIBURE_NAME = "paginationBtns";
