...
public final class WebConstantDeclaration {
	...
	public static final String REQUEST_PARAM_PATRONYMIC = "patronymic";
	public static final String REQUEST_PARAM_DATE_BIRTH = "date_birth";
	public static final String REQUEST_PARAM_HOME_PHONE = "home_phone";
	...
	public static final String REQUEST_CARD_ID = "cardId";
    public static final String REQUEST_CLIENT_ID = "clientId";
    public static final String REQUEST_ID_CARD = "idCard";
    public static final String REQUEST_ID_SERVICE = "idService";
    ...
    public static final String REQUEST_BANK_ACCOUNT = "bankAccount";
    ...
    public static final String REQUEST_PARAM_CARD_VALID_MONTH = "cardValidMonth";
    public static final String REQUEST_PARAM_CARD_VALID_YEAR = "cardValidYear";
