...
public final class HttpRequestParamValidator {
    ...
    private static final String ADDRESS_REGEX = "^[A-ZА-ЯЁ][A-Za-zА-Яа-яЁё][.,]{1,50}";
    ...
    public static boolean validateEmail(String email) throws ValidateNullRequestParamException {
        ...
        return matchToRegexCaseIns(email);
    }
    ...
    private static boolean matchToRegexCaseIns(String input) {
        Pattern p = Pattern.compile(HttpRequestParamValidator.EMAIL_REGEX, Pattern.CASE_INSENSITIVE);
