...
import static by.htp.hvozdzeu.web.command.impl.card.helper.SavePaymentParametersHelper.requestTransferAlienCardMapper;
import static by.htp.hvozdzeu.web.command.impl.card.helper.SavePaymentParametersHelper.transferAlienCardParametersMapper;
...
public class SaveTransferAlienCreditCardCommandImpl implements BaseCommand {
    ...
    public SaveTransferAlienCreditCardCommandImpl() {
    ...
    public String executeCommand(HttpServletRequest request) throws CommandException {
        ...
        attributes = requestTransferAlienCardMapper(request);

        CreditCard creditCardFrom = creditCardService.findById((Long) attributes.get("cardNumberFromId"));

        String creditCardTo = attributes.get("cardNumberToId").toString();

        if (creditCardFrom.getCardNumber().equals(creditCardTo)) {
        ...
        transferParametersMapper = transferAlienCardParametersMapper(attributes, creditCardFrom, creditCardTo);
