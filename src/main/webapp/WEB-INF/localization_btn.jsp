	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
		...
		<c:if test="${locale == 'en'}">
			<a class="dropdown-item"
				href="ServletController?command=change_locale&lang=by"><img
				class="img-m-top" src="img/flug/by.png"> BY</a>
			<a class="dropdown-item"
				href="ServletController?command=change_locale&lang=de"><img
				class="img-m-top" src="img/flug/de.png"> DE</a>
			<a class="dropdown-item"
				href="ServletController?command=change_locale&lang=ru"><img
		...
		<c:if test="${locale == 'ru'}">
			...
			<a class="dropdown-item"
				...
				class="img-m-top" src="img/flug/de.png"> DE</a>
			<a class="dropdown-item"
				href="ServletController?command=change_locale&lang=en"><img
