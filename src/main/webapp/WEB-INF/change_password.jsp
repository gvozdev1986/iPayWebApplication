                ...
                <form action="ServletController" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3 input-group-sm">
                            <label for="current_password"><i class="fas fa-key"></i> <fmt:message key="current_password"/></label>
                            <input type="password"
                                   class="form-control"
                                   id="current_password"
                        ...
                        <div class="col-md-4 mb-3 input-group-sm">
                            <label for="new_password"><i class="fas fa-key"></i> <fmt:message key="new_password"/></label>
                            <input type="password"
                                   class="form-control"
                                   id="new_password"
                        ...
                        <div class="col-md-4 mb-3 input-group-sm">
                            <label for="verify_new_password"><i class="fas fa-key"></i> <fmt:message key="verify_password"/></label>
                            <input type="password"
                                   class="form-control"
