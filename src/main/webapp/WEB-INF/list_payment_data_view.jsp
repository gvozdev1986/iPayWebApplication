            ...
            <div class="container" style="height: 50%; overflow-y: scroll; padding: 5px;">
                <table class="table table-bordered table-hover table-sm table-striped"
                    ...
                    <tr style="text-align: center; vertical-align: middle;">
                        ...
                        <td class="header-table-column" style="vertical-align: middle; font-weight: bold;"><fmt:message key="service_data_code" /></td>
                        <td class="header-table-column" style="vertical-align: middle; font-weight: bold;"><fmt:message key="service_data_name" /></td>
                        <td class="header-table-column" style="vertical-align: middle; font-weight: bold;"><fmt:message key="service_data_group" /></td>
                        <td class="header-table-column" style="vertical-align: middle; font-weight: bold;"><fmt:message key="service_data_description" /></td>
