			...
			<form>
				<div class="input-group input-group-sm mb-3">
					...
					<div class="input-group-append">
						...
						<button class="btn btn-success" type="submit" name="command"
							value="blocked_credit_cards_view" id="search-Btn">
			...
			<table
				...
				<tr style="text-align: center; vertical-align: middle;">
					...
					<td style="vertical-align: middle; font-weight: bold;">Last
						name</td>
					<td style="vertical-align: middle; font-weight: bold;">Card
						number</td>
				...
				<c:forEach items="${listBlockedCreditCard}" var="creditBlockedCards">
					<tr>
						...
						<td style="vertical-align: middle; width: 25px;"><a
							href="ServletController?command=view_detail_blocked_card&cardId=${creditBlockedCards.id}"
							style="cursor: pointer; margin-top: -7px; color: black"> <i
								class="fas fa-search"></i> ${creditBlockedCards.cardNumber}
						</a></td>
						<td
