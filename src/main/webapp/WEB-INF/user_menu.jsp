                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           ...
                           style="cursor: pointer">
                            ...
                            <fmt:message key="client_menu_pay_service"/>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                           ...
                           data-target="#typeOfTransfer">
                            ...
                            <fmt:message key="client_menu_transfer_card"/>
                        </a>
                    </li>
                </ul>
            </c:if>
                ...
                <ul class="nav flex-column mb-2">
                    <li class="nav-item">
                        <a class="nav-link disabled"
                           href="ServletController?command=payment_service_view"
                           style="cursor: pointer; color: #c3d1d4;">
                            <i class="fas fa-shopping-cart"></i>
                            <fmt:message key="client_menu_pay_service"/>
                        </a>
                    </li>
...
<div class="modal fade" id="typeOfTransfer" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-chevron-left"></i>
                    <fmt:message key="login_cancel"/></a>
                <a href="ServletController?command=transfer_view_his_card" class="btn btn-success"><i
                        class="far fa-user"></i> <fmt:message key="your_card"/></a>
                <a href="ServletController?command=transfer_view_alien_card" class="btn btn-success"><i
                        class="fas fa-users"></i> <fmt:message key="alien_card"/></a>
            </div>
        </div>
    </div>
</div>